...
class CNakedNodeFilter : public CNodeFilter
{
public:
    CBloomFilter& GetInnerFilter()
    {
...
BOOST_AUTO_TEST_CASE(merkle_block_1)
{
    ...
    CNakedNodeFilter nodeFilter;
    CBloomFilter& filter = nodeFilter.GetInnerFilter();
    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_ALL);
    // Match the last transaction
    filter.insert(uint256S("0x74d681e0e03bafa802c8aa084379aa98d9fcd632ddc2ed9782b586ec87451f20"));

    CMerkleBlock merkleBlock(block, nodeFilter);
    ...
    merkleBlock = CMerkleBlock(block, nodeFilter);
    BOOST_CHECK(merkleBlock.header.GetHash() == block.GetHash());
...
BOOST_AUTO_TEST_CASE(merkle_block_4_test_p2pubkey_only)
{
    ...
    CNakedNodeFilter nodeFilter;
    CBloomFilter& filter = nodeFilter.GetInnerFilter();
    filter = CBloomFilter(10, 0.000001, 0, BLOOM_UPDATE_P2PUBKEY_ONLY);
