...
TEST_F(SidechainsEventsTestSuite, CeasingHeightUpdateForScCreation) {
    ...
    //test
    EXPECT_TRUE(view->UpdateScInfo(scCreationTx, creationBlock, scCreationHeight));
...
TEST_F(SidechainsEventsTestSuite, CeasingHeightUpdateForFullCert) {
    ...
    //test
    EXPECT_TRUE(view->UpdateScInfo(scCreationTx, creationBlock, creationHeight));
...
TEST_F(SidechainsEventsTestSuite, UndoFullCertUpdatesToCeasingScs) {
    ...
    //test
    EXPECT_TRUE(view->RevertCertOutputs(cert, dummyCertUndo));
