...
UniValue getrawtransaction(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "       \"certProvingSystem\" : \"provingSystem\", (string) The type of proving system to be used for certificate verification, expected values:\n" + Sidechain::ProvingSystemTypeHelp() + "\n"
            ...
            "       \"cswProvingSystem\" : \"provingSystem\",  (string, optional) The type of proving system to be used for CSW verification, expected values:\n" + Sidechain::ProvingSystemTypeHelp() + "\n"
...
{   
    if (fHelp || params.size() > 6)
        throw runtime_error(
            ...
            "    [{\"epoch_length\":h, \"address\":\"address\", \"amount\":amount, \"certProvingSystem\":\"provingSystem\", \"wCertVk\":hexstr, \"customData\":hexstr, \"constant\":hexstr,\n"
            "      \"cswProvingSystem\":\"provingSystem\", \"wCeasedVk\":hexstr, \"vFieldElementCertificateFieldConfig\":[i1,...], \"vBitVectorCertificateFieldConfig\":[[n1, m1],...],\n"
            ...
            "         \"scProof\": \"hex\"            (string, required) SNARK proof whose verification key was set upon sidechain registration. Its size must be " + strprintf("%d", CScProof::MaxByteSize()) + "bytes max\n"
            "       }\n"
            "       ,...\n"
            "     ]\n"
            ...
            "         \"certProvingSystem\":\"provingSystem\"       (string, required) The type of proving system to be used for certificate verification, allowed values:\n" + Sidechain::ProvingSystemTypeHelp() + "\n"
            ...
            "         \"cswProvingSystem\":\"provingSystem\"       (string, optional) The type of proving system to be used for CSW verification, allowed values:\n" + Sidechain::ProvingSystemTypeHelp() + "\n"
