...
UniValue getrawtransaction(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "       \"certProvingSystem\" : n,          (numeric) The type of proving system to be used for certificate verification, expected values:\n" + Sidechain::ProvingSystemTypeHelp() + "\n"
            ...
            "       \"cswProvingSystem\" : n,           (numeric, optional) The type of proving system to be used for CSW verification, expected values:\n" + Sidechain::ProvingSystemTypeHelp() + "\n"
...
{   
    if (fHelp || params.size() > 6)
        throw runtime_error(
            ...
            "    [{\"epoch_length\":h, \"address\":\"address\", \"amount\":amount, \"certProvingSystem\":provingSystem, \"wCertVk\":hexstr, \"customData\":[hexstr1, hextstr2, ...], \"constant\":hexstr},...]\n"
            ...
            "         \"certProvingSystem\":provingSystem       (numeric, required) The type of proving system to be used for certificate verification, allowed values:\n" + Sidechain::ProvingSystemTypeHelp() + "\n"
            ...
            "         \"cswProvingSystem\":provingSystem       (numeric, optional) The type of proving system to be used for CSW verification, allowed values:\n" + Sidechain::ProvingSystemTypeHelp() + "\n"
...
{   
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "       \"value\" : x.xxx,                  (numeric) The value in " + CURRENCY_UNIT + "\n"
            "       \"address\" : \"hex\",              (string) The sidechain receiver address\n"
            "       \"certProvingSystem\" : n           (numeric, required) The type of proving system to be used for certificate verification, allowed values:\n"
            "       \"wCertVk\" : \"hex\",              (string) The sidechain certificate snark proof verification key\n"
            "       \"customData\" : \"hex\",           (string) The sidechain declaration custom data\n"
            "       \"constant\" : \"hex\",             (string) The sidechain certificate snark proof constant data\n"
            "       \"cswProvingSystem\" : n           (numeric, optional) The type of proving system to be used for CSW verification, allowed values:\n"
            "       \"wCeasedVk\" : \"hex\"             (string, optional) The ceased sidechain withdrawal input snark proof verification key\n"
