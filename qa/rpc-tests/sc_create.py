...
class SCCreateTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        errorString = ""
        try:
            self.nodes[2].sc_create(123, "dada", creation_amount, proving_system, vk, "", constant)
            assert(True)
        ...
        try:
            self.nodes[1].sc_create(123, "", creation_amount, proving_system, vk, "", constant)
            assert(True)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[1].sc_create(123, "ada", "", proving_system, vk, "", constant)
            assert(True)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[1].sc_create(123, "ada", Decimal("0.0"), proving_system, vk, "", constant)
            assert(True)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[1].sc_create(123, "ada", 0.1, proving_system, "zz" * SC_VK_SIZE, "", constant)
            assert(True)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[1].sc_create(123, "ada", 0.1, proving_system, "a" * (SC_VK_SIZE - 1))
            assert(True)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[1].sc_create(123, "ada", 0.1, proving_system, "aa" * (SC_VK_SIZE - 1))
            assert(True)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[1].sc_create(123, "ada", 0.1, proving_system, "aa" * SC_VK_SIZE)
            assert(True)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[1].sc_create(123, "ada", 0.1, proving_system, vk, "zz" * 1024)
            assert(True)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[1].sc_create(123, "ada", 0.1, proving_system, vk, "b" * 1023)
            assert(True)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[1].sc_create(123, "ada", 0.1, proving_system, vk, "bb" * 1025)
            assert(True)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[1].sc_create(123, "ada", 0.1, proving_system, vk, "", "zz" * SC_FIELD_SIZE)
            assert(True)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[1].sc_create(123, "ada", 0.1, proving_system, vk, "", "b" * (SC_FIELD_SIZE - 1))
            assert(True)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[1].sc_create(123, "ada", 0.1, proving_system, vk, "", "bb" * (SC_FIELD_SIZE - 1))
            assert(True)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[1].sc_create(123, "ada", 0.1, proving_system, vk, "", "aa" * SC_FIELD_SIZE)
            assert(True)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        try:
            self.nodes[1].sc_create(0, "ada", Decimal("1.0"), proving_system, vk, "aa" * SC_FIELD_SIZE)
            assert(True)
        except JSONRPCException, e:
            errorString = e.error['message']
            mark_logs(errorString, self.nodes, DEBUG_MODE)
        ...
        ret = self.nodes[1].sc_create(123, "dada", creation_amount, proving_system, vk, "bb" * 1024, constant)
